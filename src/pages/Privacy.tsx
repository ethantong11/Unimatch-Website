    ...
    <div className="relative min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-4xl mx-auto glass-card p-8 md:p-12">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-3">1) Purpose</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-3">3) Purposes of Use</h2>
          <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-3">4) Legal Basis / DPP Alignment</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-3">5) Sharing & Disclosure</h2>
          <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-3">6) Overseas Transfers</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-3">7) Retention</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-3">10) Children</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-3">11) Cookies & Tracking</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-3">12) Changes</h2>
          <p className="text-gray-300 leading-relaxed">
