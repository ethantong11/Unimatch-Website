    ...
    <div className="relative min-h-screen overflow-hidden">
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="bg-white/85 backdrop-blur-md border border-black/5 rounded-3xl shadow-lg p-8 md:p-12 text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">2) Data We Collect</h2>
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">3) Purposes of Use</h2>
            <ul className="list-disc list-inside text-body space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">4) Legal Basis / DPP Alignment</h2>
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">5) Sharing & Disclosure</h2>
            <ul className="list-disc list-inside text-body space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">6) Overseas Transfers</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">7) Retention</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">9) Security</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">10) Children</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">11) Cookies & Tracking</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">12) Changes</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">13) Contact</h2>
            <p className="text-body">
