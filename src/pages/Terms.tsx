    ...
    <div className="relative min-h-screen overflow-hidden text-[#0c0c0c]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="bg-white/85 backdrop-blur-md border border-black/5 rounded-3xl shadow-lg p-8 md:p-12">
          <h1 className="text-4xl md:text-5xl font-medium text-[#0c0c0c] mb-6">Terms of Service</h1>
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">1) Introduction</h2>
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">2) Eligibility</h2>
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">3) Your Account</h2>
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">4) Acceptable Use & Zero Tolerance Policy</h2>
            
            <h3 className="text-xl font-semibold text-[#0c0c0c] mb-2 mt-4">ZERO TOLERANCE POLICY</h3>
            ...
            <p className="text-gray-700 leading-relaxed mb-2">You agree not to upload, post, or share:</p>
            <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-1 mb-4 ml-4">
            ...
            <h3 className="text-xl font-semibold text-[#0c0c0c] mb-2 mt-4">ENFORCEMENT ACTIONS:</h3>
            <p className="text-gray-700 leading-relaxed mb-2 font-semibold">Immediate Permanent Ban (No Warning):</p>
            <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-1 mb-4 ml-4">
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">5) Content & Licence</h2>
            <p className="text-gray-700 leading-relaxed mb-2">
            ...
            <p className="text-gray-700 leading-relaxed mb-2">This includes:</p>
            <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-1 mb-2 ml-4">
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">6) Community Safety & Reporting</h2>
            
            <h3 className="text-xl font-semibold text-[#0c0c0c] mb-2 mt-4">CREATING A SAFE COMMUNITY</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#0c0c0c] mb-2 mt-4">YOUR RESPONSIBILITIES:</h3>
            <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-1 mb-4 ml-4">
            ...
            <h3 className="text-xl font-semibold text-[#0c0c0c] mb-2 mt-4">HOW TO REPORT VIOLATIONS:</h3>
            <p className="text-gray-700 leading-relaxed mb-2 font-semibold">In-App Reporting (Fastest):</p>
            <ol className="list-decimal list-inside text-gray-700 leading-relaxed space-y-1 mb-4 ml-4">
            ...
            <p className="text-gray-700 leading-relaxed mb-2 font-semibold">Email Reporting:</p>
            <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-1 mb-4 ml-4">
            ...
            <h3 className="text-xl font-semibold text-[#0c0c0c] mb-2 mt-4">SAFETY FEATURES:</h3>
            <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-1 mb-4 ml-4">
            ...
            <h3 className="text-xl font-semibold text-[#0c0c0c] mb-2 mt-4">WHAT WE MONITOR:</h3>
            <p className="text-gray-700 leading-relaxed mb-2">We actively monitor for:</p>
            <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-1 mb-4 ml-4">
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">7) Subscriptions & Payments</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">8) Privacy</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">9) Third‑Party Services</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">10) Disclaimers</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">11) Limitation of Liability</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">12) Indemnity</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">13) Changes</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">14) Governing Law & Jurisdiction</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="common-section">
            <h2 className="text-2xl font-semibold text-[#0c0c0c] mb-3">15) Contact</h2>
            <p className="text-gray-700 leading-relaxed">
