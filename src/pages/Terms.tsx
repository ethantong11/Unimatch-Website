      ...
      <div className="relative z-content max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="bg-white/30 backdrop-blur-md border border-black/5 rounded-3xl shadow-lg p-8 md:p-12 text-body dark:bg-white/20 dark:border-white/15">
          ...
          <section className="mb-8">
            ...
            <p className="text-body mb-2"><strong>Contact:</strong> base.unimatch@gmail.com</p>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">2) Eligibility</h2>
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">3) Your Account</h2>
            <ul className="list-disc list-inside text-body space-y-2">
              <li>Provide accurate information and keep your login secure. You are responsible for all activity on your account.</li>
              <li>You may delete your account in-app at any time.</li>
              <li>We may suspend or terminate accounts that violate these Terms or our guidelines, or for safety/operational reasons at any time.</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-body mb-2">You agree not to upload, post, or share:</p>
            ...
            <p className="text-body mb-2">We reserve the right to:</p>
            <ul className="list-disc list-inside text-body space-y-1 mb-4 ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">5) Content & Licence</h2>
            ...
            <p className="text-body mb-2">This includes:</p>
            <ul className="list-disc list-inside text-body space-y-1 mb-2 ml-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-body mb-2 font-semibold">Email Reporting:</p>
            <ul className="list-disc list-inside text-body space-y-1 mb-4 ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">7) Subscriptions & Payments</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">8) Privacy</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">9) Third‑Party Services</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">10) Disclaimers</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">11) Limitation of Liability</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">12) Indemnity</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">13) Changes</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">14) Governing Law & Jurisdiction</h2>
            <p className="text-body">
          ...
          <section className="mb-8">
            <h2 className="text-h2 mb-3">15) Contact</h2>
            <p className="text-body">
